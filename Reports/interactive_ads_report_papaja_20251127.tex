...
Overall, the graphic quality of the stimuli for two participant groups is well perceived (\(M_{\text{graphic quality}}\) = 5.68, \(SD_{\text{graphic quality}}\) = 0.89). The results from a Welch's independent samples \emph{t}-test indicated no significant differences between the two groups, \emph{t}(597.16) = -1.43, \emph{p} = 0.153 (see Figure 1).
